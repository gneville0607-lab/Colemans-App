...
def main():
    ...
    if not in_time_window(target_time, cfg["timezone"], cfg["time_tolerance_minutes"]):
    ...
    if mode == "morning":
        run_morning(cfg, bot_token, config_sheet, roster, supervisor, trip_people_today, today)
    else:
        run_summary(cfg, bot_token, config_sheet, roster, exempt, supervisor, owner, trip_people_today, today)


def run_morning(cfg, bot_token, config_sheet, roster, supervisor, trip_people_today, today):
...
def run_summary(cfg, bot_token, config_sheet, roster, exempt, supervisor, owner, trip_people_today, today):
